...
<h4 class="m-2 text-custom-light">Formulaire de publication d'offre d'emploi</h4>
</div>
<div class="card-body">
...
<div class="input-group w-auto">
        <input type="text" class="form-control" placeholder="Rechercher des candidats...">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card applicant-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">A postulé pour : <?= htmlspecialchars($applicant['jobTitle']); ?></p>
                            <p class="small text-muted">Expérience : <?= htmlspecialchars($applicant['experience']); ?> ans</p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                ?>
                                <a href="<?= $cvToDisplay; ?>" target="_blank" class="btn btn-sm btn-primary">Voir le CV</a>
                            </div>
                        </div>
                    </div>
                </div>
